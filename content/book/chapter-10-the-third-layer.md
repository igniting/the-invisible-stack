...
The reader — if the reader is building agents, buying agents, governing agents, regulating agents, or writing about agents — is now part of the work. The questions this book has tried to articulate are not closed questions. They are the questions the industry will be answering through the next decade, in public debates and private incidents and slow compromises across teams and companies and regulators.
